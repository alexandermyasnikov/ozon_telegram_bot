package ratesupdaterserviceexchangerate_test
...
func TestRatesUpdaterServiceExch(t *testing.T) {
	t.Parallel()
	...
	service := ratesupdaterserviceexchangerate.New()
...
func TestRatesUpdaterServiceExch_TimeUpdate(t *testing.T) {
	t.Parallel()
