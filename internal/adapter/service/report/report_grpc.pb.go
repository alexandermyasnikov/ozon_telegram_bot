...
type ReportServiceClient interface {
	GetReport(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Resp, error)
}
...
func (c *reportServiceClient) GetReport(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Resp, error) {
	out := new(Resp)
...
type ReportServiceServer interface {
	GetReport(context.Context, *Req) (*Resp, error)
...
func (UnimplementedReportServiceServer) GetReport(context.Context, *Req) (*Resp, error) {
...
func _ReportService_GetReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GetReport(ctx, req.(*Req))
	}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/adapter/service/report/report.proto",
}
